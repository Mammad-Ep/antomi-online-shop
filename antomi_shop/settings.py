"""
Django settings for antomi_shop project.
...
SECRET_KEY = 'django-insecure-t^j^l$09bplkj=#^uf2kd%h0!qy%0*_$czzpu7x3fez*ps&j*x'
...
INSTALLED_APPS = [
    ...
    'apps.scorings.apps.ScoringsConfig',
...
WSGI_APPLICATION = 'antomi_shop.wsgi.application'
